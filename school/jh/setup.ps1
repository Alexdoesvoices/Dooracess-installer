    ...
    $scriptFolder = Join-Path -Path $doorPath -ChildPath "JH"
    ...
    $url = "https://alexdoesvoices.github.io/Dooracess-installer/school/jh/setupfiles.zip"
    ...
    try {
        ...
        Write-Host "Placing files into JH folder..." -ForegroundColor Yellow
